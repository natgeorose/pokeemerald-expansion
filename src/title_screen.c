...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/serenado_title.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/serenado_title.bin.smolTM");
...
void CB2_InitTitleScreen(void)
{
    ...
    case 4:
        ...
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_1
                                    ...
                                    | DISPCNT_WIN0_ON
                                    | DISPCNT_OBJWIN_ON);
        m4aSongNumStart(MUS_BW12_UNWAVERING_EMOTIONS);
        gMain.state = 5;
        break;
    case 5:
