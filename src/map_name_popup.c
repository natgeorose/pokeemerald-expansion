...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_CAIRWIND_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MOORDEN_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_QUILSPRING_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FELLHAVEN_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SUNDARA_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_VEILBORA_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_REME_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_RAJANOR_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_KARADUNE_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ELARU_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SOLOAM_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LACUNREST_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_HIGARD_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CYNDUR_PEAK] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MT_UMBRA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ASHELODE_MINES] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_KARADUNE_CEMETARY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ELARU_TEMPLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EREWOOD_GROVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CALWYN_SPRINGS] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_COALSCORCH_QUARRY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LAKE_SERENADO] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_CRETACEOUS_PARK] = MAPPOPUP_THEME_BW_DEFAULT,
