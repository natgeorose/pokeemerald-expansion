...
const u8 gText_DexHoennTitle[] = _("Serenado Dex");
...
const u8 gText_DexHoennDescription[] = _("Serenado region's Pokédex");
...
const u8 gText_BirchInTrouble[] = _("Select your partner Pokémon!\nWho will you choose?");
...
const u8 gText_DadsAdvice[] = _("Professor Pine's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ToggleRun[] = _("Running Shoes");
const u8 gText_ToggleRunHold[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Hold");
const u8 gText_ToggleRunToggle[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Toggle");
...
const u8 gText_DexHoenn[] = _("Serenado");
...
const u8 gText_Hoenn[] = _("Serenado");
