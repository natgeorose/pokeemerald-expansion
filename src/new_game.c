...
static void SetDefaultOptions(void)
{
    ...
    gSaveBlock2Ptr->optionsToggleRun = 1;
}
...
static void WarpToTruck(void)
{
    SetWarpDestination(MAP_GROUP(MAP_CAIRWIND_TOWN_PLAYER_2F), MAP_NUM(MAP_CAIRWIND_TOWN_PLAYER_2F), WARP_ID_NONE, 1, 5);
...
static void ResetOutfitData(void)
{
    ...
    UnlockOutfit(OUTFIT_FEMALE_GREEN);
    UnlockOutfit(OUTFIT_FEMALE_RED);
