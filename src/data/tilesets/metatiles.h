...
const u16 gMetatiles_Rose[] = INCBIN_U16("data/tilesets/secondary/rose/metatiles.bin");
const u16 gMetatileAttributes_Rose[] = INCBIN_U16("data/tilesets/secondary/rose/metatile_attributes.bin");
