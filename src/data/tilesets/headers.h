...
const struct Tileset gTileset_Rose =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Rose,
    .palettes = gTilesetPalettes_Rose,
    .metatiles = gMetatiles_Rose,
    .metatileAttributes = gMetatileAttributes_Rose,
    .callback = NULL,
};
