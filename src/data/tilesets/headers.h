...
const struct Tileset gTileset_Serenado =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Serenado,
...
const struct Tileset gTileset_Cairwind =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Cairwind,
    .palettes = gTilesetPalettes_Cairwind,
    .metatiles = gMetatiles_Cairwind,
...
const struct Tileset gTileset_pc =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_pc,
    .palettes = gTilesetPalettes_pc,
    .metatiles = gMetatiles_pc,
    .metatileAttributes = gMetatileAttributes_pc,
    .callback = NULL,
};
...
const struct Tileset gTileset_Erewood =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Erewood,
    .palettes = gTilesetPalettes_Erewood,
    .metatiles = gMetatiles_Erewood,
...
const struct Tileset gTileset_Veilbora =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Veilbora,
    .palettes = gTilesetPalettes_Veilbora,
    .metatiles = gMetatiles_Veilbora,
    .metatileAttributes = gMetatileAttributes_Veilbora,
    .callback = NULL,
};

const struct Tileset gTileset_Cable =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Cable,
    .palettes = gTilesetPalettes_Cable,
    .metatiles = gMetatiles_Cable,
