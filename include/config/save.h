...
#define REGISTERED_ITEMS_MAX                8   // Maximum number of registered items if multiple registered items feature is enabled. (cannot go over 16 due to the saveblock structure)
